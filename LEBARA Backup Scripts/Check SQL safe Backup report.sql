--Run it in any server Master db: with the path and DB name
...
SET @DatabaseName           = 'LDW_DWL_DEU'
SET @ArchivePathAndFilename = '\\Leb-bakdbnas02\dba\LEB-EDWFTDW02\FULL\DML & DWL\LEB-EDWFTDW02_LDW_DWL_DEU_Full_201505291658.safe'
SET @Debug                  = 1
